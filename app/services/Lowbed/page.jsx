...
export const metadata = {
  ...
  description:
    "High-tonnage 8-wheel and 16-wheel Lowbed Trailers for transporting heavy industrial machinery, construction excavators, and out-of-gauge equipment in Chennai.",
};
...
const lowbedVehicles = [
  {
    ...
    special_features: [
      "Load Adaptive Weight Distribution",
      "Heavy Duty Goose Neck Design",
      "High-Load Radial Tyre Arrays",
      "Reinforced Main Beams & Crossmembers",
      "Ultra-Low Deck Height",
      "Strategic Lashing Points & D-Rings"
    ],
    ...
    <div className="min-h-screen bg-[#f8f9fa] pt-16 md:pt-20 pb-16 font-sans antialiased">
      ...
      <div className="relative bg-slate-900 border-b border-gray-200 shadow-sm mb-12 md:mb-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/serviceimage/ser5.jpg.jpeg"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 text-center">
          ...
          <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto">
            Low-profile drop decks engineered for industrial scale vertical
            clearance, high-tonnage heavy machinery, and dense point loads.
          </p>
        </div>
      </div>

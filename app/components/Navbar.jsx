    ...
    <nav className="fixed w-full z-50 bg-white shadow-lg py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-7">
            <Link
              href="/"
              className="text-slate-900 hover:text-blue-500 font-semibold transition-colors"
            >
              Home
            </Link>
              ...
              <div className="absolute hidden group-hover:block w-56 bg-white text-slate-800 shadow-2xl rounded-b-md border-t-4 border-blue-600">
                {segments.map((s) => (
                  <Link
                    key={s.name}
                    href={s.href}
                    className="block px-5 py-3 hover:bg-blue-50 hover:text-blue-600 border-b border-gray-100 last:border-0 font-medium"
                  >
                    {s.name}
                  </Link>
                ))}
      ...
      >
        <div className="px-6 py-4 space-y-4">
          <Link
            href="/"
            className="block text-slate-900 font-semibold hover:text-blue-600"
          >
            Home
          </Link>
          <Link
          ...
          <div className="pt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center bg-red-600 text-white px-5 py-3 rounded shadow-md font-bold hover:bg-orange-700 w-full"
            >
              VIEW BROCHURE
            </a>
          </div>

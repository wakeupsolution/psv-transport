      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 md:gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              ...
              through reliable service and smart logistics solutions provider
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start mb-4">
                {/* The Label */}
                <span className="mr-2 text-red-600 font-bold leading-6">
                  A:
                </span>

                {/* The Address Content */}
                <span className="flex-1 text-slate-300 leading-6">
                  No. 40, Pillaiyar Kovil Street,
                  <br />
              ...
              <li className="flex items-start">
                ...
                <a
                  href="mailto:contact@psvpragadeesh.com"
                  className="hover:text-white transition-colors"
                >
                  contact@psvpragadeesh.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="mr-2 text-red-500 font-bold">P:</span>
                <a
                  href="tel:+917010688410"
                  className="hover:text-white transition-colors"
                >
                  +91 70106 88410
                </a>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} PSV Pragadeesh Transport. All Rights
            Reserved.
          </p>

      ...
      <div className="relative w-full h-[55vh] min-h-[450px] flex flex-col items-center justify-center pt-10">
        ...
        <div className="relative z-10 text-center px-4 -mt-12">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto font-medium">
            Seamless supply chain solutions, from SCV local drops to extreme ODC
            haulage.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-xl shadow-slate-200/50 p-8 border-t-4 border-red-600 transform transition-transform hover:-translate-y-2">
            ...
            <p className="text-slate-600 leading-relaxed font-medium">
              No.40, Pillaiyar Kovil Cross St, Govardanagiri, Avadi, Chennai,
              Tiruvallur, Tamil Nadu - 600071
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-xl shadow-slate-200/50 p-8 border-t-4 border-blue-600 transform transition-transform hover:-translate-y-2">
            ...
            <a
              href="+91 70106 88410"
              className="text-slate-600 font-bold text-lg mb-1"
            >
              +91 70106 88410
            </a>
            <br></br>
            <a
              href="transport@psvpragadeesh.com"
              className="text-slate-600 font-bold text-lg mb-1"
            >
              sales.transport@psvpragadeesh.com
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-xl shadow-slate-200/50 p-8 border-t-4 border-red-600 transform transition-transform hover:-translate-y-2">
            ...
            <a
              href="tel:+919638715223"
              className="text-slate-600 font-bold mb-1 break-all block hover:text-blue-600"
            >
              +91 9638715223
            </a>

            <a
              href="mailto:operations.transport@psvpragadeesh.com"
              className="text-slate-600 font-bold mb-1 break-all block hover:text-blue-600"
            >
              operations.transport@psvpragadeesh.com
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="p-8 md:p-12 lg:pr-16">
            ...
            <p className="text-slate-500 mb-8 font-medium">
              Fill out the details below and our logistics experts will get back
              to you immediately.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    type="text"
                    className="w-full px-4 py-3.5 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition-all font-medium"
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">
                  Required Fleet Segment
                </label>
                <div className="relative">
                  {/* ADDED name="segment" */}
                  <select
                    name="segment"
                    className="w-full px-4 py-3.5 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition-all font-bold text-slate-700 appearance-none cursor-pointer"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full px-4 py-3.5 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition-all font-medium resize-none"
                  placeholder="Provide weight, dimensions, pickup & drop locations..."
                ></textarea>
              </div>

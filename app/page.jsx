  ...
  const reviews = [
    {
      ...
      name: "Prabu Vathsala",
      time: "3 months ago",
      text: "Experience person timing management is excellent designing output super quality and quantity 💯",
      initial: "P",
    },
    {
      id: 2,
      name: "Prakash Jayachand...",
      time: "3 months ago",
      text: "We are very happy with the construction of our house. The quality of work is very good, and the team followed proper...",
      initial: "P",
    },
    {
      id: 3,
      name: "Elumalai .M",
      time: "1 year ago",
      text: "Excellent engineer ...response and work quality very nice...little costly...",
      initial: "E",
    },
    {
      id: 4,
      name: "Suresh Kumar",
      time: "2 months ago",
      text: "Professional logistics management. The team was very punctual and delivery was safe.",
      initial: "S",
    },
    {
      id: 5,
      name: "Rajesh Chen",
      time: "4 months ago",
      text: "Best in the business for heavy machinery transport. Highly recommended for ODC cargo.",
      initial: "R",
    },
    {
      id: 6,
      name: "Anita Wilson",
      time: "5 months ago",
      text: "Seamless port connectivity. Their tracking and support are top-notch.",
      initial: "A",
    },
  ];
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 bg-white p-6 rounded-3xl shadow-xl flex items-center gap-4 border border-slate-100">
              ...
              <div className="border-l-2 border-slate-100 pl-4">
                <p className="text-[10px] font-black text-slate-800 uppercase tracking-widest leading-tight">
                  Years of
                  <br />
                  Rich Experience
                </p>
          ...
          >
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter leading-tight text-slate-900">
                <span className="text-blue-600"> PSV </span>{" "}
                <span className="text-red-600">Pragadeesh</span>{" "}
            ...
            <p className="text-slate-600 text-[15px] md:text-base leading-relaxed font-medium">
              Offering reliable surface transportation services by road across
              India. We deliver efficient and flexible logistics solutions
              tailored to handle even the most demanding industrial
              requirements.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium">
                  <strong className="text-slate-900">Massive Scale:</strong>We
                  offer a wide range of vehicles with capacities varying from 1
                  Ton to 100 Tons.
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium">
                  <strong className="text-slate-900">Versatile Cargo:</strong>{" "}
                  We safely undertake both Breakbulk and Container
                  transportation.
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium">
                  <strong className="text-slate-900">Engineering First:</strong>{" "}
                  We undertake advanced route surveys, prepare proper reports,
                  and provide cost-effective transportation models.
                </p>
              </div>
            </div>
            ...
            <blockquote className="border-l-4 border-amber-500 pl-5 py-2 bg-amber-50/50 rounded-r-xl">
              <p className="text-slate-800 font-bold italic text-[15px] leading-snug">
                "We believe that the customer is our biggest asset. Instead of
                focusing on the competition, we focus on the customer."
              </p>
            </blockquote>
        ...
        <div className="max-w-[1300px] mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="lg:w-[28%] flex flex-col items-center">
              <h3 className="text-[#FBB017] text-[28px] font-bold mb-2">
                EXCELLENT
              </h3>
            ...
            <div className="lg:w-[72%] relative w-full overflow-hidden px-2">
              <AnimatePresence mode="wait">
                ...
                >
                  {reviews
                    .slice(
                      reviewIndex * itemsPerPage,
                      reviewIndex * itemsPerPage + itemsPerPage,
                    )
                    .map((rev) => (
                      <div
                        key={rev.id}
                        className="bg-[#F2F2F2] p-7 rounded-[22px] flex flex-col min-h-[340px] relative transition-all"
                      >
                        <div className="flex items-start justify-between mb-5">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl ${rev.id % 2 === 0 ? "bg-[#E84E1B]" : "bg-[#0388D1]"}`}
                            >
                              {rev.initial}
                            </div>
                            <div className="overflow-hidden">
                              <h4 className="font-bold text-[#1A1A1A] text-[15px] leading-tight truncate">
                                {rev.name}
                              </h4>
                        ...
                        <div className="flex items-center gap-1 mb-4">
                          <div className="flex gap-0.5">
                            {[1, 2, 3, 4, 5].map((s) => (
                              <svg
                                key={s}
                                className="w-[18px] h-[18px] text-[#FBB017]"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                              >
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        ...
                        <p className="text-[#333333] text-[13.5px] leading-[1.6] font-medium mb-4">
                          {rev.text}
                        </p>

                        <div className="mt-auto">
                          <button className="text-[13px] font-bold text-gray-400 hover:text-amber-500 transition-colors">
                            Read more
                          </button>
                        </div>
                      </div>
